...
class FindItemInBundleFailed(Exception):
    pass


class GetBundleDetailsFailed(Exception):
    pass


class GetBundleRecommendationFailed(Exception):
    pass
...
class GetassetToCategoryFailed(Exception):
    pass


class GetassetToSubCategoryFailed(Exception):
    pass


class GetPlayerBundlesFailed(Exception):
    pass


class UnpackBundleFailed(Exception):
    pass
...
class GetCategoriesFailed(Exception):
    pass


class GetSubCategoriesFailed(Exception):
    pass
